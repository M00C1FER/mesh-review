...
`mesh-review` — Vendor-neutral multi-LLM PR review and summary toolkit. Two subcommands: review (consensus + adversarial Sigma falsification gate) and summary (structured PR descriptions).
